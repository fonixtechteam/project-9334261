    ...
    <header className="h-[64px] bg-white border-b border-[#ECEEF2] flex items-center justify-between px-8 sticky top-0 z-40">
      ...
      <div className="flex-1 max-w-lg mx-8">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search clients by name, sector, region..."
          ...
          {notifOpen && (
            <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-xl border border-[#ECEEF2] shadow-xl z-50 overflow-hidden">
              ...
              <div className="max-h-72 overflow-y-auto">
                {[
                  { title: "New client onboarding request", desc: "Saudi Aramco governance assessment", time: "15 min ago" },
                  { title: "Client deadline approaching", desc: "L'Oréal C-Suite evaluation closes in 3 days", time: "1 hour ago" },
                  { title: "Report approval needed", desc: "Siemens AG board composition audit", time: "3 hours ago" },
                ].map((notif, i) => (
