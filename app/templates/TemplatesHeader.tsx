    ...
    <header className="h-[64px] bg-white border-b border-[#ECEEF2] flex items-center justify-between px-8 sticky top-0 z-40">
      <div>
        ...
        <p className="text-[13px] text-[#6B7280] mt-0.5">
          Standard E&amp;B questionnaire templates
        </p>
      </div>
      ...
      <div className="flex-1 max-w-lg mx-8">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search templates by name, service, language..."
      ...
      <div className="flex items-center gap-2">
          ...
          {notifOpen && (
            <div className="absolute right-0 top-full mt-2 w-80 bg-white rounded-xl border border-[#ECEEF2] shadow-xl z-50 overflow-hidden">
              ...
              <div className="max-h-72 overflow-y-auto">
                {[
                  { title: "Template updated", desc: "Board Self Eval refreshed with new questions", time: "15 min ago" },
                  { title: "New template available", desc: "Bank Director Suitability v2.1 is live", time: "1 hour ago" },
                  { title: "Review needed", desc: "Director Training Needs flagged for refresh", time: "3 hours ago" },
                ].map((notif, i) => (
        ...
        <button className="flex items-center gap-2 px-3.5 py-2 border border-[#ECEEF2] text-[#6B7280] rounded-lg text-[13px] font-medium hover:border-[#1E50FF]/30 hover:text-[#070a4a] transition-all cursor-pointer whitespace-nowrap">
