...
import { LayoutDashboard, List, Users, BarChart3, Settings, Activity } from "lucide-react";

const tabs = [
  { id: "overview", label: "Overview", icon: LayoutDashboard, count: null },
  { id: "questions", label: "Questions", icon: List, count: 48 },
  { id: "recipients", label: "Recipients", icon: Users, count: 15 },
  { id: "responses", label: "Responses", icon: BarChart3, count: 12 },
  { id: "settings", label: "Settings", icon: Settings, count: null },
  { id: "activity", label: "Activity Log", icon: Activity, count: null },
];

export default function SurveyTabs({ activeTab, onTabChange }: { activeTab: string; onTabChange: (tab: string) => void }) {
  return (
